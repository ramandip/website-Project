<%@ Page Language="VB" AutoEventWireup="false" CodeFile="accomodation.aspx.vb" Inherits="accomodation" %>
...
Accommodation for Students was founded in June 2000 by two university students who experienced first hand the difficulties with finding student accommodation.
</p>	
		...
		<article class="expanded">
            		...
            		<h2><a href="https://www.rentboard.ca/index.aspx " target="_blank">fastest, easiest and most cost effective</a> </h2>
			<div class="article-info"><%--Posted on <time datetime="2013-05-14">14 May</time> by <a href="#" rel="author">Joe Bloggs</a>--%></div>

			
            <p>The RentBoard.ca web site is Canadian owned and operated by RentBoard Canada, Inc. Originally online in July of 1998, RentBoard Canada Inc. operates these web sites:<br />
            <br />
•	www.RentBoard.ca
RentBoard.ca allows property owners and managers to advertise their vacancies to hundreds of thousands of renters across Canada. RentBoard.ca is the fastest, easiest and most cost effective way to fill your rental vacancies! 
<br /><br />
•	www.RentBoard.ca Mobile Site
The RentBoard.ca mobile web site allows you to search and view rental listings on nearly any mobile device. The mobile site allows you to set a location and then find rental properties within a given distance of that location. 
</p>
